...
export class RequesterService {
  ...
  deleteSupplier(supplier: Supplier) {
    ...
    return this.httpclient.delete(this.base_url + '/suppliers/delete', {
      responseType: 'text',
      body: supplier,
    });
  }
  ...
  addSupplier(supplier: Supplier) {
    return this.httpclient.put(this.base_url + '/suppliers/add', supplier, {
      responseType: 'text',
    });
  }
  ...
  getSupplierPagination(pageNum: number): Observable<string> {
    return this.httpclient.get(this.base_url + '/pagination/suppliers/' + pageNum, {
      responseType: 'text',
    });
  }
  ...
  stockPagination(pageNum: number): Observable<string> {
    return this.httpclient.get(this.base_url + '/pagination/stocks/' + pageNum, {
      responseType: 'text',
    });
  }
  ...
  addCategory(category: Category): Observable<any> {
    return this.httpclient.put(this.base_url + '/categories/add', category, {
      responseType: 'text',
    });
  }

  deleteCategory(category: Category): Observable<any> {
    return this.httpclient.delete(this.base_url + '/categories/delete', {
      body: category,
      responseType: 'text',
    });
  }
  ...
  updateCategory(category: Category): Observable<any> {
    return this.httpclient.put(this.base_url + '/categories/update', category, {
      responseType: 'text',
    });
  }

  categoryPagination(pageNum: number): Observable<string> {
    return this.httpclient.get(this.base_url + '/pagination/categories/' + pageNum, {
      responseType: 'text',
    });
  }
